...
keys = [
    ...
    Key([mod], "space", lazy.spawn("rofi -show"),
        desc="Launch Application Switcher"),
    Key([mod], "r", lazy.spawn("rofi -show drun"),
        desc="Launch Application Launcher"),
    Key([mod], "b", lazy.spawn("firefox"), desc="Launch Firefox"),
    # Media Keys
    Key([], "XF86AudioLowerVolume", lazy.spawn(
        "amixer sset Master 2%-"), desc="Lower volume",),
    Key([], "XF86AudioRaiseVolume", lazy.spawn(
        "amixer sset Master 2%+"), desc="Raise volume",),
    Key([], "XF86AudioMute", lazy.spawn(
        "amixer -D pulse set Master toggle"), desc="Mute volume",),
...
def get_widgets():
    widgets = [
        ...
        widget.CurrentLayoutIcon(
            ...
            scale=0.8,
            background=catppuccin['red'],
            custom_icon_paths=['/home/albin/.config/qtile/icons/'],
        ),
        ...
        widget.CapsNumLockIndicator(
            fmt=' {}', background=catppuccin['yellow']),
        widget.TextBox(
            text='',
            padding=0,
            fontsize=30,
...
screens = [
    Screen(
        wallpaper='/usr/share/backgrounds/tree.jpg',
        top=bar.Bar(
            get_widgets(),
            24,
            background='#00000000',
